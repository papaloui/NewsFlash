...
/**
 * @fileOverview Summarizes a given article URL into a concise overview.
 *
...
const SummarizeArticleOutputSchema = z.object({
  summary: z.string().describe('A 3-5 sentence summary of the article.'),
});
...
const summarizeArticlePrompt = ai.definePrompt({
  ...
  prompt: `Summarize the following article into a concise 3-5 sentence overview.\n\nArticle: {{{articleContent}}}`,
});
